...
class DataImportNotification extends BaseNotification implements ShouldQueue
{
    ...
    public function toDatabase(object $notifiable): array
    {
        ...
        if ($hasErrors && $this->successCount === 0) {
            ...
            return [
                ...
                'message' => 'The data import could not be completed. Please check the errors and try again.'.($errorList ? "\n\nErrors:\n".$errorList : ''),
                'link' => null,
                'data' => [
        ...
        if ($hasErrors) {
            ...
            return [
                ...
                'message' => sprintf(
                    'Data import completed. %d records processed successfully, but %d had errors.',
                    $this->successCount,
                    count($this->errors)
                ).($errorList ? "\n\nErrors:\n".$errorList : ''),
                'link' => null,
        ...
        return [
            ...
            'message' => sprintf(
                'Data import completed successfully. %d records were processed.',
                $this->successCount
            ),
            'link' => null,
            'data' => [
