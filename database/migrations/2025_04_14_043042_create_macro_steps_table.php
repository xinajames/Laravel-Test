...
return new class extends Migration
{
    ...
    {
        Schema::create('macro_steps', function (Blueprint $table) {
            $table->id();
            $table->foreignId('batch_id')->references('id')->on('macro_batches');
            $table->foreignId('upload_id')->references('id')->on('macro_uploads');
            ...
            $table->unsignedInteger('status')->default(MacroStepStatusEnum::Pending()->value);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('macro_steps');
    }
};
