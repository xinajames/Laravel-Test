                ...
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    >
                        ...
                        >
                            ...
                            <DataTableItem>
                                <div class="block rounded-md p-2 transition">
                                    <a
                                        :href="row.documentable_link"
                                        class="font-medium hover:underline"
                                    >
                                        {{ row.documentable_name }}
                                    </a>
                                    <div class="text-sm text-gray-500">
                                        {{ row.documentable_type }}
                                    </div>
                                </div>
                            </DataTableItem>
                                    ...
                                    <template v-slot:menu>
                                        ...
                                        >
                                            <MenuItems class="flex flex-col w-full">
                                                ...
                                                <MenuItem
                                                    v-if="
                                                        (row.documentable_type === 'franchisee' &&
                                                            canUpdateFranchisees) ||
                                                        (row.documentable_type === 'store' &&
                                                            canUpdateStores)
                                                    "
                                                    class="w-full"
                                                >
                                ...
                                <div class="flex flex-col justify-center items-center p-6 gap-6">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-gray-600 text-sm">
                                            Keep everything organized — upload your franchisee and
                                            store documents.
                                        </p>
                                    </div>
                                </div>
