...
const formattedMessage = computed(() => {
    ...
    // Replace line breaks with HTML breaks and bullet points with proper HTML
    return props.notification.message.replace(/\n/g, '<br>').replace(/• /g, '&bull; ');
});
</script>
                        ...
                        >
                            ...
                            <div class="sm:flex sm:items-start">
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left w-full">
                                    <DialogTitle
                                        as="p"
                                        class="text-base font-semibold leading-6 text-gray-900 pr-8"
                                    >
                                        {{ notification?.header }}
                                    </DialogTitle>
                                    <div class="mt-4">
